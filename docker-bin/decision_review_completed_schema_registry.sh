export TOPIC=BIA_SERVICES_BIE_CATALOG_LOCAL_DECISION_REVIEW_COMPLETED_V01
...
echo "DecisionReviewCompleted AVRO was uploaded to the Schema-registry successfully"
