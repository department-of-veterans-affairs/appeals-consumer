...
source $THIS_SCRIPT_DIR/decision_review_completed_schema_registry.sh

while ! curl -s http://localstack-consumer:4666/_localstack/health  | grep -q -E '"sqs": "available"|"sqs": "running"'; do
