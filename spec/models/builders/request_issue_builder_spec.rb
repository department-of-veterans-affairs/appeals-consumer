...
describe Builders::RequestIssueBuilder do
  ...
  describe "#assign_attributes" do
    it "calls private methods" do
      ...
      expect(builder).to receive(:assign_contention_reference_id)
      expect(builder).to receive(:assign_contested_rating_decision_reference_id)
      expect(builder).to receive(:assign_contested_rating_issue_profile_date)
      ...
      expect(builder).to receive(:assign_decision_date)
      ...
      expect(builder).to receive(:assign_contested_rating_issue_diagnostic_code)
