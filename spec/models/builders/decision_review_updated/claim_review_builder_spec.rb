...
describe Builders::DecisionReviewUpdated::ClaimReviewBuilder do
  ...
  describe "#assign_attributes" do
    it "calls private methods" do
      ...
      expect(builder).to receive(:assign_remand_source_id)
  ...
  describe "#assign_auto_remand" do
    ...
    #     expect(subject).to eq(Builders::DecisionReviewUpdated::ClaimReviewBuilder::FILED_BY_VA_GOV)
    #   end
  end

  describe "#assign_remand_source_id" do
  ...
  describe "#assign_legacy_opt_in_approved" do
