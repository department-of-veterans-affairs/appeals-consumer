    ...
    message_payload do
      {
        ...
        "claim_received_date" => Date.new(2022, 1, 1).to_time.to_i,
        ...
        "intake_creation_time" => Time.now.utc.to_time.to_i,
        "claim_creation_time" => Time.now.utc.to_time.to_i,
        ...
        "decision_review_issues" => [
          {
            ...
            "prior_decision_notification_date" => Date.new(2022, 1, 1).to_time.to_i,
