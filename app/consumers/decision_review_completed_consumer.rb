...
class DecisionReviewCompletedConsumer < ApplicationConsumer
  include LoggerMixin
  EVENT_TYPE = Events::DecisionReviewCompletedEvent

  # rubocop:disable Metrics/MethodLength
  def consume
    MetricsService.record("Consuming and creating messages",
                          service: :kafka,
                          name: "DecisionReviewCompletedConsumer") do
        ...
        begin
          ActiveRecord::Base.transaction do
            ...
            process_event(event, extra_details) do |new_event|
              DecisionReviewCompletedEventProcessingJob.perform_later(new_event)
            end
          end
